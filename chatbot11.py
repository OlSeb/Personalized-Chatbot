...
def main():
    ...
    st.sidebar.info(
       '''Select fictionnal or non-fictionnal character, who you want to talk with, and then start chatting!'''
    )


    # Create text area widget to receive a question
    question = st.text_area(f"You:")
    ...
    if st.button("Send"):
        ...
        st.text_area(f"{option}:", value=response, height=None)
